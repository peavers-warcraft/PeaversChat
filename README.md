...
|---|---:|---:|:--:|
| Packaged size | 208.2 KB | 215 KB | pass |
...
| switching tabs, 1/sec | 0.00 | 19.9 | 20 calls to repaint the whole tab row; 709 calls to skin every window at login, once |
...
<sub>5,377 lines of Lua · 208.2 KB packaged · no bundled libraries</sub>
