...
| switching tabs, 1/sec | 0.00 | 19.9 | 20 calls to repaint the whole tab row; 718 calls to skin every window at login, once |
...
<sub>5,660 lines of Lua · 222.2 KB packaged · no bundled libraries</sub>
